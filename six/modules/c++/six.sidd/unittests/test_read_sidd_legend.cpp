...
struct TestHelper
{
    ...
    void write()
    {
        ...
        const auto buffer1 = coda_oss::make_unique<sys::ubyte[]>(dims1.area());
        ...
        const auto buffer2 = coda_oss::make_unique<sys::ubyte[]>(dims2.area());
        std::fill_n(buffer2.get(), dims2.area(), static_cast<sys::ubyte>(100));

        auto monoLegend(coda_oss::make_unique<six::Legend>(mMonoLegend));
        ...
        const auto buffer3 = coda_oss::make_unique<sys::ubyte[]>(dims3.area());
        ...
        auto rgbLegend(coda_oss::make_unique<six::Legend>(mRgbLegend));

        const auto buffer4 = coda_oss::make_unique<sys::ubyte[]>(dims4.area());
